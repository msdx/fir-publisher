...
class SimpleMultipartEntity implements HttpEntity {
    ...
    void addPart(final String key, final String value) {
    ...
    void addPart(final String key, final String fileName, final InputStream fin, final boolean isLast) {
        addPart(key, fileName, fin, "application/octet-stream", isLast)
    }

    void addPart(final String key, final String fileName, final InputStream fin,
    ...
    void addPart(final String key, final File value, final boolean isLast) {
        try {
